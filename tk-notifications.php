  ...
  // function tk_notifications_api_callback( WP_REST_Request $request ) {
    ...
    add_action( 'rest_api_init', function() {
      ...
      function tk_notifications_create_ajax_form() {
        ...
        <!-- <p><label for="url">Email address:</label></p>
        <p><input id="email" type="text" class="tk_notifications_email"></p> -->
      ...
      add_shortcode('tknotificationsajax', 'tk_notifications_create_ajax_form'); // Muuta shortcode monikkoon!
      ...
      function tk_notifications_ajax_form_layout() {
        ...
        // echo '<p><input type="hidden" id="taxonomies" name="taxonomies[post_type]" value="post_type"></p>';
        // echo '<p><input type="hidden" id="taxonomies" name="taxonomies[category]" value="category"></p>';
        // echo '<p><input type="hidden" id="taxonomies" name="taxonomies[tag]" value="tag"></p>';
        // echo '<p><input type="hidden" id="taxonomies" name="taxonomies[rating]" value="rating"></p>';
